...
# Step 4: Create Plot 4: Four plots in one page and store it in PNG file:
...
plot(hpcdata$DateTime, as.numeric(as.character(hpcdata$Voltage)), type = "l", ylab = "Voltage", xlab = "datetime")
plot(hpcdata$DateTime, as.numeric(as.character(hpcdata$Global_reactive_power)), type = "l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()
